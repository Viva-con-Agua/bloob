...
//import com.mohiva.play.silhouette.impl.providers.oauth2.state.{ SessionStateProvider, SessionStateSettings, DummyStateProvider }
...
//    val settings = configuration.underlying.as[SessionStateSettings]("silhouette.oauth2StateProvider")
